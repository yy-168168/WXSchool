...
function select(obj, index){
	...
	$('#mainTab').hide();
	var bcl = $(obj).css("background-color");
	...
	<body onload="checkMM();" style="margin: 0; background-color: #009966; color: #fff">
		...
		<div id="" style="display: none">
			<table width="100%" height="100%" border="0" class="tab">
				<tr><td align="center"></td></tr>
				<tr><td align="center" height="20%"><div style="animation: hideToShowRight 1s ease 0.8s 1 both;; -webkit-animation: hideToShowRight 1s ease 0.8s 1 both; font-size: 30px;">我不怕过光棍节</div></td></tr>
				<tr><td align="center" height="20%"><div style="animation: hideToShowLeft 1s ease 1.6s 1 both;; -webkit-animation: hideToShowLeft 1s ease 1.6s 1 both; font-size: 30px;">我怕我喜欢的人</div></td></tr>
				<tr><td align="center" height="20%"><div style="animation: hideToShowRight 1s ease 2.4s 1 both;; -webkit-animation: hideToShowRight 1s ease 2.4s 1 both; font-size: 50px; color: #FBED7A">不过光棍节</div></td></tr>
				<tr><td align="center" height="20%"><div style="animation: hideToShowLeft 1s ease 3.2s 1 both;; -webkit-animation: hideToShowLeft 1s ease 3.2s 1 both; font-size: 50px; color: #FBED7A">......</div></td></tr>
				<tr><td align="center"></td></tr>
			</table>
			<div class="btn-prev"><span class="glyphicon glyphicon-chevron-right"></span></div>
		</div>
		...
		<div id="" style="display: none">
			<table width="100%" height="100%" border="0" class="tab">
				<tr><td align="center"></td></tr>
				<tr><td align="center" height="25%"><div style="animation: hideToShowTop 1s ease 0.8s 1 both;; -webkit-animation: hideToShowTop 1s ease 0.8s 1 both; font-size: 30px;">每逢佳节</div></td></tr>
		...
		<div id="" style="display: none">
			<table width="100%" height="100%" border="0" class="tab">
				<tr><td align="center"></td></tr>
				<tr><td align="center" height="25%"><div style="animation: hideToShowLeft 1s ease 0.8s 1 both;; -webkit-animation: hideToShowLeft 1s ease 0.8s 1 both; font-size: 30px; color: #D66F98">但愿人长久</div></td></tr>
		...
		<div id="" style="display: none">
			<table width="100%" height="100%" border="0" class="tab">
				...
				<tr><td align="center" height="25%"><div style="animation: hideToShowLeft 1s ease 1.6s 1 both;; -webkit-animation: hideToShowLeft 1s ease 1.6s 1 both; font-size: 50px;">暗恋我的人</div></td></tr>
				<tr><td align="center" height="25%"><div style="animation: hideToShowDown 1s ease 2.4s 1 both;; -webkit-animation: hideToShowDown 1s ease 2.4s 1 both; font-size: 50px;">还不<span style="color: #90B0CF">表白</span>么</div></td></tr>
				<tr><td align="center"></td></tr>
			</table>
			<div class="btn-prev"><span class="glyphicon glyphicon-chevron-right"></span></div>
		</div>
		...
		<div id="" style="display: none">
			<table width="100%" height="100%" border="0" class="tab">
				<tr>
					<td align="center">
						<div style="animation: hideToShow 1s ease 1.0s 1 both; -webkit-animation: hideToShow 1s ease 1.0s 1 both; font-size: 40px">
							<div>不管你是一个人</div>
		...
		<div id="mainTab" style="display: none">
			<table width="100%" height="100%" border="0">
				<tr><td align="center">
					<div onclick="select(this, 1)" class="tabItem" style="animation: hideToShow 1s ease 0.8s 1 both; -webkit-animation: hideToShow 1s ease 0.8s 1 both; background-color: #666699">寻找暗恋的人</div>
					<div onclick="select(this, 2)" class="tabItem" style="animation: hideToShow 1s ease 1.6s 1 both; -webkit-animation: hideToShow 1s ease 1.6s 1 both; background-color: #CC6600">来一波美女/帅哥</div>
					<div onclick="select(this, 3)" class="tabItem" style="animation: hideToShow 1s ease 2.6s 1 both; -webkit-animation: hideToShow 1s ease 2.6s 1 both; background-color: #99CC00">给Ta买份早餐</div>
					<div onclick="select(this, 4)" class="tabItem" style="animation: hideToShow 1s ease 3.6s 1 both; -webkit-animation: hideToShow 1s ease 3.6s 1 both; background-color: #FF6666">送Ta一束鲜花</div>
					<div onclick="select(this, 5)" class="tabItem" style="animation: hideToShow 1s ease 4.6s 1 both; -webkit-animation: hideToShow 1s ease 4.6s 1 both; background-color: #009999">求助于助手君</div>
					<div onclick="select(this, 6)" class="tabItem" style="animation: hideToShow 1s ease 5.6s 1 both; -webkit-animation: hideToShow 1s ease 5.6s 1 both; background-color: #CCCC99">认识BOSS</div>
					...
					<div style="animation: hideToShow 1s ease 7.6s 1 both; -webkit-animation: hideToShow 1s ease 7.6s 1 both; margin-top: 20px; font-size: 13px"><span style="text-decoration: underline;" onclick="showScreenNotice_img('static_/gztx.jpg')">分享</span>&nbsp;&nbsp;<span style="text-decoration: underline;" onclick="showScreenNotice_img('static_/gztx.jpg')">转发</span></div>
				</td></tr>
			</table>
		</div>
		...
		<div id="item4" style="display: none">
			<table width="100%" height="100%" border="0" class="item">
				<tr><td align="center"></td></tr>
				<tr><td align="center"><div style="animation: hideToShow 1s ease 0.8s 1 both; -webkit-animation: hideToShow 1s ease 0.8s 1 both;">这是你第几次给Ta送花</div></td></tr>
		...
		<div id="item6" style="display: none">
			<table width="100%" height="100%" border="0" class="item">
				...
				<tr><td align="center"><div style="animation: hideToShow 1s ease 5.6s 1 both; -webkit-animation: hideToShow 1s ease 5.6s 1 both;"><img alt="" src="static_/bossWechat.png" width="160px"></div></td></tr>
				<tr><td align="center"></td></tr>
			</table>
		</div>
