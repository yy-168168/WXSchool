...
function check() {
	...
	var mn = syncSubmit("/mngs/bns?ac=usedNum&token=<%=token%>&type=<%=type%>&wxin="
			+ wxin + "&tel=" + tel);
	if (mn == "wxinOverMaxNum") {
		showNotice("该微信号使用次数超过最大配额");
		return false;
	} else if (mn == "telOverMaxNum") {
		showNotice("该手机号使用次数超过最大配额");
		return false;
	}
	...
	<body>
		...
		<div class="content">
			...
			<div class="right">
				<div class="title">
					添加二手物品(为了节约用户流量，请修改图片大小，仅限上传一张图片)
						...
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								...
								<td>
									...
									<span class="textSpan">非二手全新品请发到格子铺</span>
								</td>
							</tr>
							<tr>
								<td class="form_title">
