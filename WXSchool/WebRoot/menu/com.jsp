...
function updateUseAccount(tp, url) {
	...
	<body style="margin: 0px;">
		<div class="bg"
			style="background-image: url('http://bcs.duapp.com/yy-pic/NM1Lp4exi1.jpg');">
		</div>
		...
		<div id="con"
			...
			<div class="mybox">
				<div class="mainmenu">
					<table width="100%" height="100%" cellpadding="0" cellspacing="0"
						border="0"
						onclick="location='vs?ac=listbiaobai&userwx=<%=userwx%>&wxaccount=<%=wxaccount%>'">
						<tr>
							<td align="center">
			...
			<div class="mybox">
				...
				<div class="submenu">
					<table width="100%" height="100%" cellpadding="0" cellspacing="0"
						border="0"
						onclick="location='/mobile/board?ac=listthing&wxaccount=<%=wxaccount%>&userwx=<%=userwx%>&cate=7'">
						<tr>
							<td align="center">
			...
			<div class="mybox">
				<div class="mainmenu">
					<table width="100%" height="100%" cellpadding="0" cellspacing="0"
						border="0"
						onclick="location='friends?ac=isExist&wxaccount=<%=wxaccount%>&userwx=<%=userwx%>'">
						<tr>
							<td align="center">
			...
			<div class="mybox">
				<div class="mainmenu">
					<table width="100%" height="100%" cellpadding="0" cellspacing="0"
						border="0"
						onclick="location='/mobile/food?ac=getRess&wxaccount=<%=wxaccount%>'">
						<tr>
							<td align="center">
			...
			<div class="mybox">
				...
				<div class="submenu">
					<table width="100%" height="100%" cellpadding="0" cellspacing="0"
						border="0"
						onclick="location='edu/cet_login1.jsp?wxaccount=<%=wxaccount%>'">
						<tr>
							<td align="center">
			...
			<div class="mybox">
				<div class="mainmenu">
					<table width="100%" height="100%" cellpadding="0" cellspacing="0"
						border="0"
						onclick="location='/mobile/article?ac=getArticles&cate=美文&wxaccount=<%=wxaccount%>&userwx=<%=userwx%>'">
						<tr>
							<td align="center">
