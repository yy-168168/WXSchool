<%@ page language="java" import="java.util.*,java.text.*,com.wxschool.entity.*" pageEncoding="utf-8"%>
<%
...
<body onload="checkMM()">
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 15px">
		<tr>
			...
			<td width="100%">
				<div class="item_shit">出错啦，未获取到数据</div>
			</td>
		</tr>
	</table>
	<%
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 15px">
		<tr>
			...
			<td width="100%">
				<div class="item_shit">
					<div style="padding-bottom: 6px; font-family: '微软雅黑', Tahoma, Verdana, Arial, Helvetica, sans-serif;">
						<%=shit.getContent()%>
					</div>
	...
	<div>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 15px">
			<tr>
				<td valign="middle">
					<div style="height: 40px; line-height: 40px; width: 64px; border-radius: 32px/20px; text-align: center;background-color: <%=reply.getOther()%>">
						<span style="font-size: 13px; color: #fff"><%=num%></span>
					</div>
				</td>
				<td width="100%">
					<div class="item_shit" style="margin-left: 15px">
	...
	<div id="pubBtn" style="margin-top: 15px;">
		<input type="button" value="点此发布评论" class="html5btn" onclick="showPubForm();" style="background: #428BCA; color: #fff;">
		<script type="text/javascript">
