...
.contttext:last-child {
	...
	<body onload="checkMM();">
		<div
			...
			<div
				style="background-color: #FF9900; text-align: center; color: #fff; padding: 5px 10px 0 10px;">
				<span style="font-size: 20px;">信誉第一    服务至上</span>
			</div>
			<div
				style="background-color: #FF9900; text-align: right; color: #fff; font-size: 12px; padding: 3px 5px 1px 0;">
