...
public class ImagePreProcess3 {
	 ...
	 * @return
	 */
	public ImagePreProcess3 changeToBlackWhiteImage() {
	 ...
	 * @return
	 */
	public ImagePreProcess3 midddleValueFilter(int whiteAreaMinPercent,
	 ...
	 * @return
	 */
	public ImagePreProcess3 changeToGrayImage() {
		int gray;
		Color point;
		for (int i = 0; i < height; i++) {
			for (int j = 0; j < width; j++) {
	 ...
	 * @return
	 */
	public ImagePreProcess3 removeBadBlock(int blockWidth, int blockHeight,
	 ...
	 * @return
	 */
	public ImagePreProcess3 modifyBlank(int addFlag) {
	...
	public BufferedImage getBufferedImage(String filename) {
		...
		try {
			...
			Logger.getLogger(ImagePreProcess3.class.getName()).log(Level.SEVERE, null,
					ex);
			return null;
		}
	}
